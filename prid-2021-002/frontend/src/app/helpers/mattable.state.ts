...
export class MatTableState {
    ...
    //lier directement les propriétés à celles du MatTableDataSource de userlist.component car celles-ci sont Observables
    ...
    setSort(sort: MatSort, active: string, direction?: 'asc' | 'desc') {
        if(active) {
    ...
    setPage(paginator: MatPaginator, pageIndex: number, pageSize: number) {
    ...
    setFilter(dataSource: MatTableDataSource<any>, filter: string) {
